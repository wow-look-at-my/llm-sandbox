...
export const SettingsProviders: Component = () => {
  ...
  const sandboxSettings = loadSettings()
  const [baseUrl, setBaseUrl] = createSignal(sandboxSettings.baseUrl)
  const [apiKey, setApiKey] = createSignal(sandboxSettings.apiKey)
  const [model, setModel] = createSignal(sandboxSettings.model)
    ...
    <div class="flex flex-col h-full overflow-y-auto no-scrollbar px-4 pb-10 sm:px-10 sm:pb-10">
      ...
      <div class="flex flex-col gap-8 max-w-[720px]">
        <div class="flex flex-col gap-1">
          <h3 class="text-14-medium text-text-strong pb-2">API</h3>
          <SettingsList>
